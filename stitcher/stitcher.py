...
def create_panorama(video_path, frame_interval=15, roi_expansion=80, output_path="../panorama_output.jpg"):
    """Оптимизированная версия для Jetson Orin Nano с поддержкой CUDA."""
...
if __name__ == "__main__":
    video_path = "../flight_10.mp4"
    create_panorama(video_path, frame_interval=30, roi_expansion=100)
